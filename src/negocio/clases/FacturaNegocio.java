...
public class FacturaNegocio {
    ...
    public String IngresarFactura(Factura pFactura) throws Exception{
        ...
        try {
            if (pFactura.getNumeroFactura() <= 0){
                throw new Exception("Error: El numero de factura no puede ser meno o igual a 0");
            }
            if (String.valueOf(pFactura.getNumeroFactura()).isEmpty()){
                throw new Exception("Error: El numero de factura no puede estar vacío");
            }
            if (pFactura.getCliente().isEmpty()){
                throw new Exception("Error: El cliente no puede estar vacío");
            }
            if (pFactura.getCliente().length() < 3){
                throw new Exception("Error: Nombre cliente demasiado corto");
            }
            if (pFactura.getEmpleado().isEmpty()){
                throw new Exception("Error: El empleado no puede estar vacío");
            }
            if (pFactura.getEmpleado().length() < 3){
                throw new Exception("Error: Nombre empleado demasiado corto");
            }
            if (String.valueOf(pFactura.getFecha()).isEmpty()){
                throw new Exception("Error: Fecha no puede estar vacía");
            }
            if (pFactura.getFecha().getYear() > 2021){
                throw new Exception("Error: Fecha ingresada invalida");
            }
            if (pFactura.getProducto().isEmpty()){
                throw new Exception("Error: El producto no puede estar vacío");
            }
            if (pFactura.getProducto().length() < 4){
                throw new Exception("Error: Nombre de producto demasiado corto");
            }
            if (String.valueOf(pFactura.getCantidad()).isEmpty()){
                throw new Exception("Error: Cantidad de producto no puede estar vacío");
            }
            if (pFactura.getCantidad() <= 0){
                throw new Exception("Error: Cantidad de producto no puede ser menor o igual a 0");
            }
            if (String.valueOf(pFactura.getSubTotal()).isEmpty()){
                throw new Exception("Error: SubTotal no puede estar vacío");
            }
            if (pFactura.getSubTotal() < 0){
                throw new Exception("Error: SubTotal no puede ser menor que 0");
            }
            if (pFactura.getISV() < 0){
                throw new Exception("Error: El ISV no puede ser menor a 0");
            }
            if (String.valueOf(pFactura.getISV()).isEmpty()){
                throw new Exception("Error: El valor del ISV no puede estar vacío");
            }
            if (String.valueOf(pFactura.getTotalPagar()).isEmpty()){
                throw new Exception("Error: Total a pagar no puede estar vacio");
            }
            if (pFactura.getTotalPagar() <= 0){
                throw new Exception("Error: El total a pagar no puede ser menor a 0");
            }
    ...
    public void Eliminar(Factura pFactura)throws Exception{
        try {
            if (pFactura.getNumeroFactura() <= 0){
                throw new Exception("Error: El numero de factura no puede ser menor o igual a 0");
            }
            if (String.valueOf(pFactura.getNumeroFactura()).isEmpty()){
                throw new Exception("Error: El numero de factura no puede estar vacío");
            }
